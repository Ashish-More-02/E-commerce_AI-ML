# PrimeShop eCommerce Platform (v2)

> eCommerce platform built with the MERN stack & Redux.

<img src="./frontend/public/images/screens.png">

This project is part of my [MERN Stack From Scratch | eCommerce Platform](https://www.traversymedia.com/mern-stack-from-scratch) course. It is a full-featured shopping cart with PayPal & credit/debit payments. See it in action at https://www.Primeshopdemo.dev

This is version 2.0 of the app, which uses Redux Toolkit. The first version can be found [here](https://Primeshopdemo.dev)
...
please refer to the [originalcoursecode](https://github.com/bradtraversy/Primeshop-v2/tree/originalCourseCode) branch of this repository.
...
> Code changes can be seen in [ProfileScreen.jsx](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/screens/ProfileScreen.jsx)
...
> Code changes can be seen in [SearchBox.jsx](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/components/SearchBox.jsx)
...
> Code changes can be seen in [uploadRoutes.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/backend/routes/uploadRoutes.js)
...
> Changes can be seen in [errorMiddleware.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/backend/middleware/errorMiddleware.js), [productRoutes.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/backend/routes/productRoutes.js), [productController.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/backend/controllers/productController.js) and [checkObjectId.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/backend/middleware/checkObjectId.js)
...
>
> - [PlaceOrderScreen.jsx](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/screens/PlaceOrderScreen.jsx)
> - [OrderScreen.jsx](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/screens/OrderScreen.jsx)
> - [ProductEditScreen.jsx](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/screens/admin/ProductEditScreen.jsx)
> - [ProductListScreen.jsx](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/screens/admin/ProductListScreen.jsx)
...
> Changes can be seen in:-
>
> - [authSlice.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/slices/authSlice.js)
> - [cartSlice.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/slices/cartSlice.js)
> - [Header.jsx](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/components/Header.jsx)
...
> Changes can be seen in:
>
> - [cartUtils.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/utils/cartUtils.js)
> - [calcPrices.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/backend/utils/calcPrices.js)
...
>
> - [apiSlice.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/slices/apiSlice.js)
...
from our [authSlice.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/frontend/src/slices/authSlice.js) as it's never
...
some adjustments to our [backend/server.js](https://github.com/bradtraversy/Primeshop-v2/tree/main/backend/server.js)
Change...
